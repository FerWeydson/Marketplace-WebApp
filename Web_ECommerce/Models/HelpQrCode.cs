...
namespace Web_ECommerce.Models
{
    ...
    {
        private async Task<byte[]> GerarQrCode(string dadosBanco)
        {
        ...
        public async Task<IActionResult> DownloadQrCode(CompraUsuario compraUsuario, IWebHostEnvironment _environment)
        {
            using (var doc = new PdfSharpCore.Pdf.PdfDocument())
            {
                ...
                var tituloInfo_1 = new PdfSharpCore.Drawing.XFont("Arial", 18, XFontStyle.Regular);
                ...
                detalhes.DrawString(compraUsuario.QuantidadeProduto.ToString(), tituloInfo_1, corFonte, new XRect(150, alturaTituloDetalhesY, page.Width, page.Height));
                ...
                detalhes.DrawString("Canhoto para pagamento online", tituloInfo_2, corFonte, new XRect(20, alturaTituloDetalhesY, page.Width, page.Height));
                #endregion
                ...
                using (MemoryStream stream = new MemoryStream())
                {
                    ...
                    return File(stream.ToArray(), contentType, "Boleto.pdf");
                }
